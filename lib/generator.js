...
exports.default = function (node) {
  var matchs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  // let matchs = [ 'this.state', 'this.setState' ]

  var _transform = (0, _babelCore.transform)('this.state', {
  ...
  (0, _outputFile2.default)('this-state.json', _ast_regenerator(ast));

  var astJson = _ast_regenerator(node);
  return astJson;
};
